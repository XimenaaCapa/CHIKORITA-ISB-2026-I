...
<img width="1026" height="625" alt="descarga (7)" src="https://github.com/user-attachments/assets/a5519038-16c8-4615-9ac3-43f036725347" />


### 6.2 Estado de contracción del músculo bíceps
## Primer minuto
<img width="1026" height="625" alt="descarga (8)" src="https://github.com/user-attachments/assets/f98fe108-4cef-4042-81d7-d04c86b42970" />



##  Segundo minuto
<img width="1021" height="625" alt="descarga (9)" src="https://github.com/user-attachments/assets/ebc4f5cf-2562-45ad-9977-138f85ffd5d7" />




### 6.3 Estado basal del músculo trapecio
<img width="1026" height="624" alt="descarga (10)" src="https://github.com/user-attachments/assets/65ff6f67-ca00-4b87-aded-b4c0b4deb6c6" />



### 6.4 Estado de contracción del músculo trapecio
<img width="1026" height="625" alt="descarga (11)" src="https://github.com/user-attachments/assets/121b787b-98a7-4b45-8b27-e0195a117afe" />
...
Sí, la señal corresponde a lo esperado. Durante la realización de movimientos circulares hacia atrás con los hombros, se anticipaba una mayor activación muscular al elevar el hombro, lo cual se refleja en las variaciones de amplitud observadas en la señal EMG. De la misma manera se evidencia en el músculo bíceps, donde se observa un incremento similar de la amplitud durante la contracción del bíceps. En ambas señales, se identifican amplitudes bajas en la fase inicial de reposo(basal), seguidas de un aumento significativo durante la contracción muscular. Esto es consistente con la fisiología del EMG, ya que el incremento en la amplitud se asocia con el reclutamiento progresivo de unidades motoras y el aumento en la frecuencia, lo que genera una mayor actividad eléctrica registrada[3].

Asimismo, la presencia de una pequeña señal durante el reposo puede explicarse por ruido fisiológico o ruido ambiental, interferencias de dispositivos electrónicos o impedancia en la interfaz piel y electrodo. En nuestra caso es posible que se obtuvo una pequeña señal en el estado basal debido a que no se realizó una limpieza previa de la piel, además de que en la segunda ubicación de los electrodos en la zona del trapecio se emplearon los mismos electrodos que se usaron para biceps lo que reduce la obtención de una señal más limpia. Para reducir este efecto, en la literatura se encontró que se realiza esta limpieza previa en la piel con el fin de disminuir la impedancia y mejorar la calidad de la señal[4].

En conclusión, es importante considerar que la amplitud de la señal EMG aumenta durante la contracción muscular. Sin embargo, esta no depende únicamente de la fuerza generada, sino también de diversos factores como la colocación de los electrodos, la adecuada preparación de la piel y la ubicación del músculo analizado, como el caso de la zona del cuello, donde existen múltiples músculos adyacentes, y puede registrarse actividad proveniente de músculos cercanos, incluso cuando el músculo de interés se encuentra en reposo, lo que contribuye a la presencia de ruido en la señal.

### **¿Equivale la amplitud de la EMG a la cantidad de fuerza que has generado con tu músculo?**
No, la amplitud de la señal EMG no es igual a la cantidad de fuerza generada por el músculo, a pesar de que existe una correlación clara entre ambas, no existe una ecuación exacta que describe esta relación de forma directa, ya que es un proceso no lineal que depende de muchos factores.[5]
Es por ello que al momento de análisis se debe tener en cuenta el tipo de contracción. Por ejemplo, en las contracciones excéntricas se puede producir una fuerza mecánica muy alta con una amplitud de EMG baja, mientras que en las concéntricas se necesita mucha más activación neural, en la cual poseen una mayor amplitud para generar la misma cantidad de fuerza.[5]
Luego, influyen factores mecánicos esenciales como la longitud de la fibra muscular y la velocidad de contracción. Esto significa que un mismo nivel de amplitud EMG puede resultar en diferentes niveles de fuerza dependiendo de la posición de la articulación o de qué tan rápido se esté moviendo el músculo en ese momento.Por último, los factores externos como el tejido graso subcutáneo o la fatiga muscular afectan la amplitud detectada.[6]
...
* [3] Friedhelm Sandbrink, MD, “Motor Unit Recruitment in EMG: Definition of Motor Unit Recruitment, Order of Recruitment, Assessment of Recruitment at Low Level of Muscle Contraction,” Medscape.com, Apr. 14, 2025. https://emedicine.medscape.com/article/1141359-overview
* [4] W. M. B. W. Daud, A. B. Yahya, C. S. Horng, M. F. Sulaima, and R. Sudirman, “Features Extraction of Electromyography Signals in Time Domain on Biceps Brachii Muscle,” International Journal of Modeling and Optimization, pp. 515–519, 2013, doi: 10.7763/ijmo.2013.v3.332.
* [5]Romero Avila E, Williams SE, Disselhorst-Klug C. Advances in EMG measurement techniques, analysis procedures, and the impact of muscle mechanics on future requirements for the methodology. Journal of Biomechanics. 2023;156:111687.
* [6] Jonkman AH, Warnaar RSP, Baccinelli W, Carbon NM, D’Cruz RF, Doorduin J, et al. Analysis and applications of respiratory surface EMG: report of a round table meeting. Critical Care. 2024;28(2):1-17.
