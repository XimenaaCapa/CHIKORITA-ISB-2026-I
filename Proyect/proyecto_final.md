...
A partir de la señal ECG registrada, se realizará el procesamiento correspondiente para la detección de los intervalos RR y el cálculo de parámetros de HRV como el RMSSD, SDNN y la relación LF/HF, los cuales han demostrado ser indicadores confiables del estado de estrés. De esta manera, se busca establecer condiciones experimentales adecuadas para la detección objetiva del estrés cognitivo y validar la viabilidad para un sistema wearable.
